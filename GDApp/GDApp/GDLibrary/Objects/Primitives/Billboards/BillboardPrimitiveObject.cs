...
namespace GDLibrary
{
    ...
    public class BillboardPrimitiveObject : TexturedPrimitiveObject, ICloneable
    {
        ...
        {
            return new BillboardPrimitiveObject("clone - " + this.ID, this.ObjectType, (Transform3D)this.Transform3D.Clone(), this.VertexData, this.Effect,
            this.Color, this.Alpha, this.Texture, this.BillboardParameters.BillboardType);
        }
    }
}
