...
namespace GDLibrary
{
    public class CollidableObject : ModelObject
    {
        ...
        public CollidableObject(string id, ObjectType objectType, Transform3D transform, Effect effect, Texture2D texture, Model model, Color color, float alpha)
        ...
        public override void Remove()
        {
            ...
            //call base to perform chain of removals
            base.Remove();
        }
    }
}
